...
<div class="ixText"><div class="ixTxt"><span style="color: #000000;">Let your business take a new direction</span></div></div>
    ...
    <tr> 
	    <td height="30" colspan="2"> 
	    	<hr size="1" align="CENTER" width="475" noshade=""> 	
	    </td>
	  </tr>
		<tr>
			<td align="CENTER">
				<span class="testoblubold">
				<p><font class="testoblubold"> Situazione della spedizione </font></p><p><font class="testobold">Lettera di Vettura: 289633A257311</font></p>
				</span>
			</td>
		</tr>		
		<tr>
		...
		<tr align="center">
			<td>
	   		<span class="testobold">
				<b>Il codice inserito non risulta nei nostri sistemi, potrebbe essere errato oppure la spedizione non &#xFFFD; stata ancora affidata a SDA.<br>Verifica con il mittente la data di partenza o controlla il codice.</b>
			</span>
		</td>
	  </tr>			
	   <tr height="30">
	  ...
	  <tr align="center">
	  	...
	  	<td>
		  	<img src="template/img/indietro.png" height="30" onclick="indietro();">
		</td>
	  </tr>	
