...
exports.rawBody = `(mocked data)<!--?xml version="1.0" encoding="UTF-8" ?--><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xml:lang="it" xmlns="http://www.w3.org/1999/xhtml"><head>
		<title>SDA Tracking Lettera di Vettura</title>
				

<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<!--  <script language="JavaScript"	src="js/prototype/dist/prototype.js"></script>-->
<script language="JavaScript">
<!--

var globalIdDiv='';
function manageResponse(response, status){
	enableButton(false); 
	showDiv('block', globalIdDiv);
}
...
function errore(mex_errore)
{
	document.write("<html><body bgcolor=\"#9999CC\" leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\"><table width=450 border=0 bgcolor=\"#CCCCE6\"><tr><td><br><br><br><center><font size=\"3\" color=\"#333366\" face=\"Arial\"><b>ATTENZIONE:</b></font></center></td></tr><tr><td><center><font size=\"2\" color=\"#333366\" face=\"Arial\"><b>"+mex_errore+"</b></font></center></td></tr><tr><td><br><br>");
	document.write("<HR SIZE=\"1\" ALIGN=\"CENTER\" WIDTH=400 noshade></td></tr><tr><td><br><br><br><FONT SIZE=\"1\" FACE=\"Arial,Helvetica,Geneva,Swiss,SunSans-Regular\"><center>&copy; SDA Express Courier &#149; 2007&#149;</center></FONT><br><br><br></td></tr></table></body></html>");
}
*/

//Aggancio la mia funzione sull'evento onkeydown della pagina
document.attachEvent("onkeydown", nof5); 

//Creo il gestore dell'evento

function nof5() { 
	switch (event.keyCode) 
	{ 
		case 116 : // 'F5' tasto di refresh
			event.returnValue = false; 
			event.keyCode = 0; 
			window.status = ""; 
		break; 
		
		case 117 : // 'F6' riabilita F5
			event.returnValue = false; 
			event.keyCode = 0; 
			window.status = ""; 
		break; 
		
		case 8 : // 'F7' riabilita F6
			event.returnValue = false; 
			event.keyCode = 0; 
			window.status = ""; 
		break; 
...
function enableButton(_active)
{
	document.form1.button.disabled =_active;
}

function insSecurityCode(idDiv) 
{  
	//alert('codiceSicurezzaAjaxDiv: '+idDiv);
	//document.getElementById("message").style.display = "none";
	enableButton(true);
	showDiv('none', idDiv);	
	var execute='ActionTracking.doInsSecurityCode';	
	//var urlServer='./dispatcher?'; //Produzione	
	var urlServer='./dispatcherHol?'; 
	var pars= 'execute2='+execute+'&ses_id=NlZ3BvY0rdv-vzcPnBew-wW&codice_sicurezza=C33988G02742M04162S59924Y79826&codice_sicurezza_request=C33988G02742M04162S59924Y79826&firstAcs=';

	// vitber - 20120123 - Cambiata modalit� chiamata AJAX, passando da prototype a jquery, gi� inclusa nell'intestazione di INSIDEX
	//new Ajax.Updater(idDiv, urlServer,{method:'get', parameters:pars, onComplete:function(response){enableButton(false); showDiv('block', idDiv);}});				
...
function showDiv(_show, idDiv)
{	
	document.getElementById(idDiv).style.display  = _show;
}
...
function avvia(codice_sicurezza)
{
	document.getElementById("codice_sicurezza").value = codice_sicurezza;
		//PIEPEN 14102011 SDADT00007709
		//MODIFICA MESSAGGIO SU LUNGHEZA LDV
		//if(form.id_ldv.value.length!=7 & form.id_ldv.value.length!=9 & form.id_ldv.value.length!=13)
	//NICGOR 21112011 SDADT00008056
	//if(form.id_ldv.value.length!=13)
	if(document.form1.id_ldv.value.length!=7 & document.form1.id_ldv.value.length!=9 & document.form1.id_ldv.value.length!=13 & document.form1.id_ldv.value.length!=15)
	  //errore("Attenzione! Inserire 13 cifre per la lettera di vettura.");
	  errore("Attenzione! Inserire 7, 9, 13 o 15 cifre per la lettera di vettura.");
	else if(document.form1.id_ldv.value.indexOf("F2209J")==0)
	  errore("Lettera di Vettura non riconosciuta");
	else if(document.form1.id_ldv.value.indexOf("f2209J")==0)
	  errore("Lettera di Vettura non riconosciuta");
	else if(document.form1.id_ldv.value.length==15 && (document.form1.id_ldv.value.indexOf("J")==-1 && document.form1.id_ldv.value.indexOf("j")==-1) )
	  errore("Lettera di Vettura non riconosciuta");
	else
...
{   
  var wavURL    = '"dispatcher?execute2=ActionTracking.doGetSound&ses_id=NlZ3BvY0rdv-vzcPnBew-wW&text_immagine=MNSECU"';
  var embedCode = '<EMBED SRC=' + wavURL + ' HIDDEN="true" AUTOSTART="true" />';
  document.getElementById("suono").innerHTML = ""; 
  document.getElementById("suono").innerHTML = embedCode; 
}

function alertSound() 
{
   var wavURL2    = '"/img_tmp/img_tracking/messaggio_apertura.wav"'; 
   var embedCode2 = '<EMBED SRC=' + wavURL2 + ' HIDDEN="true" AUTOSTART="true"/>';     
   document.getElementById("playAudio").innerHTML = ""; 
   document.getElementById("playAudio").innerHTML = embedCode2; 
}
function alfaNum(event)
//consente solo di scrivere numeri e lettere
{
        if ((event.keyCode >= 48 && event.keyCode <=57)||(event.keyCode >= 97 && event.keyCode <=122) || (event.keyCode >= 65 && event.keyCode <=90) || event.keyCode == 13 || event.keyCode == 10)
        {
                return true;
        }
        else
...
<script type="text/javascript" id="ixPageProperty_jsfedbarnoresp" src="http://www.sda.it/risorse-fedbar-noresp/js/js-fedbar-noresp.js"></script>
	...
	<div id="onloadDiv" style="display:none">
		insSecurityCode(&apos;codiceSicurezzaAjaxDiv&apos;);
...
<form action="dispatcher" method="GET" name="form1">
	  ...
	  <tbody><tr> 
	    ...
	    <td width="550">
	      <table width="550" cellpadding="0" cellspacing="0">
        	...
        	<font color="#035FA6" size="2" face="Arial, Helvetica, sans-serif" style="position:relative; top:5px"><strong>Ricerca Spedizioni</strong></font>              
          
        	<hr size="1">
          	<font color="#000000" size="2" face="Arial, Helvetica, sans-serif" style="position:relative; top:-5px">Il sistema di tracking online con cui monitorare l&apos;iter  delle spedizioni dal ritiro alla consegna.
			   </font><p>&#xA0;</p> 
    		    ...
    		    <tr> 
		          <td align="center" height="100"><br> 
		            <font class="testoblubold">Inserire qui il numero di spedizione o l&apos;avviso di mancata consegna</font><br><br>
		              <input type="text" size="16" maxlength="15" name="id_ldv" onkeypress="return alfaNum(event);" value="289603A257318">					  
		              <input type="HIDDEN" name="execute2" value="ActionTracking.doGetSpedizioneSec">
		              <input type="HIDDEN" name="ses_id" value="NlZ3BvY0rdv-vzcPnBew-wW">
		              <input type="HIDDEN" name="code" value="ldv">		              		           
		              <input type="HIDDEN" name="codice_sicurezza" value="C33988G02742M04162S59924Y79826">
		              <input type="HIDDEN" name="codice_sicurezza_request" value="C33988G02742M04162S59924Y79826">
		              <input type="HIDDEN" name="firstAcs" value=""> 
		              
		              <div id="codiceSicurezzaAjaxDiv" style="display:block">
	                     <input type="hidden" id="codice_sicurezza" name="codice_sicurezza" value="">
		              	 <input type="hidden" id="codice_sicurezza_request" name="codice_sicurezza_request" value=""> 
		              	 <input type="hidden" id="firstAcs" name="firstAcs" value="">  
	                  </div>
	                      
		              
		              	<input type="HIDDEN" name="flagRacc" value="">
		              		              
		            <p>
					 <br>
		          </p></td>
		        </tr>
		        <!-- PIEPEN 14012011 - SDADT00004165 Modifica sicurezza Tracking on line - CODICE CAPTCHA DISMESSO  					   		    	
		        <tr>
		        	<td align="CENTER" valign="CENTER">
		        		<font class="testonero"><a href="/informative/informativa_captcha.htm" target="_blank" class="linkaccr">Requisiti per la configurazione della sintesi vocale.</a></font>
		        	</td>	
		        </tr>	
		        -->	
      				...
      				<table width="300" cellpadding="0" cellspacing="0" border="0">       					   		    	
					        ...
					        <tbody><tr> 
					          <td colspan="3" align="center"> 
							     <input type="button" name="button" value="Avvia la ricerca" onclick="avvia(this.form, &apos;C33988G02742M04162S59924Y79826&apos;);">
					          </td>
					        </tr>
					        <tr> 
					          <td height="35">
...
exports.sesId = 'NlZ3BvY0rdv-vzcPnBew-wW';
exports.codiceSicurezza = 'C33988G02742M04162S59924Y79826';
exports.execute2 = 'ActionTracking.doGetSpedizioneSec';